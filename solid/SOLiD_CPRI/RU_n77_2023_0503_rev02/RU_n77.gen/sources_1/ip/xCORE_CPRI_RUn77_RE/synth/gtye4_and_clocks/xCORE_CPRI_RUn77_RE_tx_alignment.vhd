...
-- Project : CPRI
--------------------------------------------------------------------------
-- File : xCORE_CPRI_RUn77_RE_tx_alignment.vhd
--------------------------------------------------------------------------
...
entity xCORE_CPRI_RUn77_RE_tx_alignment is
  Generic( 
...
end xCORE_CPRI_RUn77_RE_tx_alignment;

architecture rtl of xCORE_CPRI_RUn77_RE_tx_alignment is

  attribute DowngradeIPIdentifiedWarnings: string;
  attribute DowngradeIPIdentifiedWarnings of rtl : architecture is "yes";


  component xCORE_CPRI_RUn77_RE_tx_sync 
...
begin
    ...
    tx_sync_i : xCORE_CPRI_RUn77_RE_tx_sync
    generic map
    ( NUMBER_OF_LANES     =>  4,
      MASTER_LANE_ID      =>  0
    )
