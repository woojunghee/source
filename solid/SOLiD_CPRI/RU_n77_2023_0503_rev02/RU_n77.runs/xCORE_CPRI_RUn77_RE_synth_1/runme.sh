...
HD_PWD='D:/K2_Project/UQ_DAS/RU_n77/RU_n77.runs/xCORE_CPRI_RUn77_RE_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xCORE_CPRI_RUn77_RE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xCORE_CPRI_RUn77_RE.tcl
